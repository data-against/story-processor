...
def process_projects_in_parallel(projects_list: List[Dict], pool_size: int):
    args_list = [(p, DEFAULT_STORIES_PER_PAGE, DEFAULT_MAX_STORIES_PER_PROJECT) for p in projects_list]
...
if __name__ == '__main__':
    ...
    tasks.send_project_list_slack_message_task(project_results, processor.SOURCE_MEDIA_CLOUD, start_time)
    tasks.send_project_list_email_task(project_results, processor.SOURCE_MEDIA_CLOUD, start_time)
