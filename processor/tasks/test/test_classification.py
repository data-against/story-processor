...
import processor.tasks.classification as classification
...
class TestClassification(unittest.TestCase):
    def _classify_story_ids(self, project, story_ids):
        ...
        with Session() as session:
            classified_stories = classification._add_confidence_to_stories(
    ...
    def test_add_entities_to_stories(self):
        ...
        for sid in story_ids:
            with open(
                ...
                s["source"] = SOURCE_MEDIA_CLOUD
                stories_with_text.append(s)
        stories_with_entities = classification.add_entities_to_stories(
            stories_with_text
        )
